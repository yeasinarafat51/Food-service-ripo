...
const Blog = () => {
    ...
    return (
        <div className='text-center bg-cyan-100'>
            ...
            <p> JWTs are a good way of securely transmitting informatio between parties because they can be signed, which means you can be sure that the senders are who they say they are. Additionally, the structure of a JWT allows you to verify that the content hasn't been tampered with.</p>
